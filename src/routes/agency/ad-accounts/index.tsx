              ...
              >
                ...
                <TableCell>
                  <div className="flex items-center gap-1.5">
                    ...
                    {/* Where this account comes from: the agency's own Meta
                        connection, or the platform pool it was granted from. */}
                    <Badge
                      variant={account.is_platform ? 'secondary' : 'outline'}
                      className="shrink-0 text-[10px]"
                      title={
                        account.is_platform
                          ? 'Granted to you from the platform pool'
                          : 'Connected through your own Meta credentials'
                      }
                    >
