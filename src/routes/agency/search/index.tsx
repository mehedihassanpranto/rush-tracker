...
export const Route = createFileRoute('/agency/search/')({
...
function SearchPage() {
  ...
  function submit(e: React.FormEvent) {
    ...
    void navigate({ to: '/agency/search', search: { q: next } })
  }
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          >
            {data.paymentRequests.map((r) => (
              <Link key={r.id} to="/agency/payment-requests" className="group block">
                <Row primary={r.request_number} />
              </Link>
            ))}
          </ResultGroup>
